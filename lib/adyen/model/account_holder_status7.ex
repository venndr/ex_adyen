...
defmodule AdyenForPlatforms:AccountAPI.Model.AccountHolderStatus7 do
  @moduledoc """
...
defimpl Poison.Decoder, for: AdyenForPlatforms:AccountAPI.Model.AccountHolderStatus7 do
