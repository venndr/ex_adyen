...
defmodule AdyenForPlatforms:AccountAPI.Model.UnSuspendAccountHolderResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: AdyenForPlatforms:AccountAPI.Model.UnSuspendAccountHolderResponse do
