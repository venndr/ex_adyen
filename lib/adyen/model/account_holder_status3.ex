...
defmodule AdyenForPlatforms:AccountAPI.Model.AccountHolderStatus3 do
  @moduledoc """
...
defimpl Poison.Decoder, for: AdyenForPlatforms:AccountAPI.Model.AccountHolderStatus3 do
