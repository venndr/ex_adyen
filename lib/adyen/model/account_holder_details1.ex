...
defmodule AdyenForPlatforms:AccountAPI.Model.AccountHolderDetails1 do
  @moduledoc """
...
defimpl Poison.Decoder, for: AdyenForPlatforms:AccountAPI.Model.AccountHolderDetails1 do
