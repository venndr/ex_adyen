...
defmodule AdyenForPlatforms:AccountAPI.Model.KycSignatoryCheckResult do
  @moduledoc """
...
defimpl Poison.Decoder, for: AdyenForPlatforms:AccountAPI.Model.KycSignatoryCheckResult do
