...
defmodule AdyenForPlatforms:AccountAPI.Model.AccountHolderDetails4 do
  @moduledoc """
...
defimpl Poison.Decoder, for: AdyenForPlatforms:AccountAPI.Model.AccountHolderDetails4 do
