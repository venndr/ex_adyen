...
defmodule AdyenForPlatforms:AccountAPI.Model.KycVerificationResult21 do
  @moduledoc """
...
defimpl Poison.Decoder, for: AdyenForPlatforms:AccountAPI.Model.KycVerificationResult21 do
