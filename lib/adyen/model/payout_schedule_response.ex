...
defmodule AdyenForPlatforms:AccountAPI.Model.PayoutScheduleResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: AdyenForPlatforms:AccountAPI.Model.PayoutScheduleResponse do
