...
defmodule Adyen.Model.VoidPendingRefundRequest do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :"modificationAmount" => Adyen.Model.Amount.t | nil,
...
defimpl Poison.Decoder, for: Adyen.Model.VoidPendingRefundRequest do
