...
defmodule AdyenForPlatforms:AccountAPI.Model.CloseAccountHolderResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: AdyenForPlatforms:AccountAPI.Model.CloseAccountHolderResponse do
