...
defmodule AdyenForPlatforms:AccountAPI.Model.AccountHolderDetails3 do
  @moduledoc """
...
defimpl Poison.Decoder, for: AdyenForPlatforms:AccountAPI.Model.AccountHolderDetails3 do
