...
defmodule AdyenForPlatforms:AccountAPI.Model.AccountHolderStatus2 do
  @moduledoc """
...
defimpl Poison.Decoder, for: AdyenForPlatforms:AccountAPI.Model.AccountHolderStatus2 do
